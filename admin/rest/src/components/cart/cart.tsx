...
const Cart = () => {
  ...
  let shopId : string;
  if(hasAccess(ownerOnly, permissions) || hasAccess(staffOnly, permissions)){
  const {
    query: { shop },
  } = router;
  ...
  function handleCheckout() {
    ...
    // if (regularCheckout) {
      ...
      else if(hasAccess(ownerOnly, permissions) || hasAccess(staffOnly, permissions))
      {
        router.push(ROUTES.OWNER_CHECKOUT(shopId))
      }
